...
INSERT INTO authorized_user(client_id, client_secret, authorized_grant_type, scope) VALUES ('client3', 'password12345', 'authorization_code,refresh_token', 'user,repo');
...
INSERT INTO authorized_user_role(client_id, role) VALUES ('client3', 'ROLE_USER');